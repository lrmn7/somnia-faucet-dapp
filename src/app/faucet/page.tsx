...
export default function FaucetPage() {
  ...
  const isFaucetEmpty =
    ...
    balance.value < claimAmount;

  const isButtonDisabled =
    isLoading || !isConnected || (cooldown > 0 && !isOwner) || isFaucetEmpty;
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <PixelatedCard>
        <p className="text-2xl text-center mb-2">
          Get free tokens for the Somnia Network Testnet
        </p>
        ...
        <div className="flex flex-col items-center">
          ...
          {isConnected && (
            <p className="mt-4 text-sm">
              You can claim{" "}
              {typeof claimAmount === "bigint"
                ? `${formatEther(claimAmount)} STT`
                : "..."}{" "}
              {cooldownTime !== undefined
                ? formatDuration(Number(cooldownTime))
                : "..."}
              .
            </p>
          )}
